angular.module('finapp').controller('CustomerBalanceDetailController', function ($scope, $http, Utility) {
 console.log('logging from ProfitLossDetailController');
  ...
  var request = $http({
    method: 'POST',
    url: '/data/customer-balance-detail'
  });
